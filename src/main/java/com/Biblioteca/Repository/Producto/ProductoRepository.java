...
public interface ProductoRepository extends JpaRepository<Producto, Long> {
    ...
    @Query(value = "SELECT * FROM producto WHERE  empresa_id = :idEmpresa  AND stock <=:cantidad ORDER BY nombre ASC", nativeQuery = true)
    List<Producto> findAllByIdEmpresaStock(Long idEmpresa , int cantidad);
